...
function Content() {
  ...
  return <div className="min-h-screen bg-slate-50"><Sidebar/><main className="p-5 md:ml-64 md:p-10"><div className="mx-auto max-w-6xl">
    <header className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between"><div><h1 className="text-3xl font-bold">Notice Board</h1><p className="text-slate-500">Targeted, pinned and acknowledgement-aware notices.</p></div><button className="btn bg-brand-700 text-white" onClick={openCreate}><Plus/>New Notice</button></header>
