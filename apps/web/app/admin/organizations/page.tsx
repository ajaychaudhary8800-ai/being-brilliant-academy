...
type OrganizationForm = { slug: string; name: string; email: string; adminName: string; adminEmail: string; logoUrl: string | null; primaryColor: string; secondaryColor: string; timezone: string; locale: string; currency: string; academicYearStartMonth: number; groupLabelType: string; customGroupLabel: string; subscriptionStatus: string; subscriptionPlan: string; trialEndsAt: string; subscriptionEndsAt: string };
type OrganizationBranding = { logoUrl: string | null; primaryColor: string; secondaryColor: string; timezone: string; locale: string; currency: string; academicYearStartMonth: number; groupLabelType: string; customGroupLabel: string | null };
type SaaSPlan = { code: string; name: string; trialDays: number; isActive: boolean };
const empty: OrganizationForm = { slug: "", name: "", email: "", adminName: "", adminEmail: "", logoUrl: null, primaryColor: "#1d4ed8", secondaryColor: "#0f172a", timezone: defaultOrganizationTimezone, locale: "en-IN", currency: "INR", academicYearStartMonth: 4, groupLabelType: "BATCH", customGroupLabel: "", subscriptionStatus: "TRIAL", subscriptionPlan: "STANDARD", trialEndsAt: "", subscriptionEndsAt: "" };
...
export default function Page() {
  ...
  async function save(event: FormEvent) {
    ...
    try {
      ...
      const patchPayload = editing ? { slug: form.slug, name: form.name, email: form.email, ...branding, ...subscription } : { ...branding };
